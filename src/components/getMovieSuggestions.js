...
const GetMovieSuggestions = () => {
  ...
  return (
    <div className="mx-24 p-4  my-8 bg-opacity-80  text-black overflow-y-scroll no-scrollbar max-h-[40rem] w-[23rem] sm:w-[42rem] lg:w-[72rem] flex flex-col  justify-center">
